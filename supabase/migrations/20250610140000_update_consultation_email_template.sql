        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#111520;border:1px solid #1e2433;">
          ...
          <tr>
            <td align="center" style="padding:24px 32px 8px;">
              <img src="{{HERO_IMAGE_URL}}" alt="{{AGENCY_NAME}}" width="200" style="display:block;margin:0 auto;max-width:200px;height:auto;border:1px solid #1e2433;" />
            </td>
          </tr>
          <tr>
            <td style="padding:16px 32px 32px;border-top:1px solid #1e2433;">
