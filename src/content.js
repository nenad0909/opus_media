...
const TICKER = [
  ...
  const CASE_STUDIES = [
    ...
    {
      slug: "lola-gallery",
      title: "Painter's gallery site gives Lola's work a distinct digital home",
      client: "Lola Gallery",
      industry: "Fine Art",
      services: ["Web Design", "SEO"],
      segment: "B2C",
      summary: "A gallery website created for painter Lola, designed to make her work easy to discover and explore online.",
      result: "Gallery website launched",
      image: "/images/portfolio/16x9/lolaj_homepage.webp",
    },
    {
      slug: "stillpoint-mh",
