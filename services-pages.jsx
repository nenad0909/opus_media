/* Services hub + Service detail template */

function ServicesHubPage() {
  const { SERVICES, SERVICE_CATEGORIES, SERVICES_STATS, GOALS, TESTIMONIALS } = window.SITE;
  const topSlugs = ["international-expansion", "german-market-expansion", "social-media-ads", "google-ads"];
...
function ServiceDetailPage({ slug }) {
  const { SERVICES, CASE_STUDIES } = window.SITE;
...
Object.assign(window, { ServicesHubPage, ServiceDetailPage, GoalsTabs, NotFoundFragment });
